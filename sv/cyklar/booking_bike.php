...
<div class="pagecontainer">
    ...
    <div class="topicwide" >       
    	...
    	<p> Du har genomfört bokningen med följande specifikationer: <br />Bokningsnummer: '.$Bokningsnummer.'<br />
                     Namn: '.$fname.' '.$lname.'<br />Telefon: '.$tel.'<br />Epost: '.$epost.'<br />Övrig info: '.$info.'<br /> Datum: '.$cykelfom.' - '.$cykeltom.' <br /> Antal cyklar: '.$antal.' <br /> Vegolunch: '.$vego.'<br />Fisklunch: '.$fisk.'<br />Kallskuret: '.$kott.' 
                     </p>
                     <p>Vänligen ange ditt bokningsnummer ('.$Bokningsnummer.') vid kontakt med oss så vi kan hjälpa dig på bästa sätt. </p>
                     <p> Välkommen!</P>
...
<div class="pagecontainer">
    ...
    <div class="topicwide" >       
    	...
    	<h2>Tyvärr!</h2>
    	<p>Endast '.$bike_check.' lediga cyklar vald dag! <br /> Gå tillbaka och ändra i bokningen eller ring 0506 - 77 75 50 så kanske vi kan hjälpa dig!</p>
...
echo '<div class="field" style="visibility: visible;">
		...
		<h2 class="page_one">Boka cykel!</h2>
        <div class="page_one">
        
        <label for="datepicker">Startdag *</label><br />
        <input type="text" name="cykelfom" id="from" readonly="true" value=""><br />
        <label for="datepicker">Slutdag *</label><br />
        <input type="text" name="cykeltom" id="to" readonly="true" value=""><br />
        <br />
        <label>Antal cyklar vuxen</label><br />
        ...
        <label>(Hyra av barncyklar, barnsadlar och cykelkärror anges i fältet för övrig information på nästa sida.)</label><br /><br />
        <br />
        
        
        <label>Lunchpicknick tillval</label><br />
        <label>Antal vegetarisk</label><br />
        ...
        <label>Antal kallskuret</label><br />
        <select name="kott" id="kott" onchange="lunchAntal(this)"><option value="0"></option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option></select><br />
            ...
            <input type="button" name="next" onclick="nextPage()" value="Fortsätt!"> 
            </div>
        
        <div class="page_two">
        <h2 style="top:-35px;">Slutför bokning!</h2><input type="button" name="next" onclick="prevPage()" style="position:absolute; width:30px; height:20px; right:0%; top:-30px; padding:0px;" value="<<"> 
        ...
        <label for="comments">Övrig information (Allergier, kampanjkod, etc.)</label><br />
            <textarea  name="comments" maxlength="1000" cols="27" rows="6"></textarea><br /><br />
        <input type="submit" name="submitbike" onclick="return checkOut()" value="Bekräfta bokning"> 
        </div></form>';
        ?>
