    ...
    if ($bike_check >= $antal){
            ...
            $booked .= "$x_value, ";
                ...
                if (mysqli_query($conn, $sql)) {
                    ...
                    $email_message = "Vielen Dank für Ihre Buchung!
                    Sie haben folgendes gebucht: \r\n\r\Buchungsnummer: $Bokningsnummer \r\n
                     Name: $fname $lname \r\n Telefon: $tel\r\nE-Mail: $epost \r\nWeitere Informationen: $info \r\n Datum: $cykelfom - $cykeltom \r\n Anzahl Fahrräder: $antal \r\n Picknick vegetarisch: $vego \r\n Picknick mit Fisch: $fisk \r\n Picknick mit Aufschnitt: $kott 
                     \r\n\r\n
                     Bitte geben Sie Ihre Buchungsnummer ($Bokningsnummer) an, wenn Sie bezüglich Ihrer Buchung uns kontaktieren. \r\n\r\nHerzlich Willkommen!";
...
<div class="pagecontainer">
    ...
    <div class="topicwide" >       
    	...
    	<p>Sie haben folgendes gebucht: <br />Buchungsnummer: '.$Bokningsnummer.'<br />
                     Name: '.$fname.' '.$lname.'<br />Telefon: '.$tel.'<br />E-Mail: '.$epost.'<br />Weitere Informationen: '.$info.'<br /> Datum: '.$cykelfom.' - '.$cykeltom.' <br /> Anzahl Fahrräder: '.$antal.' <br /> Picknick vegetarisch: '.$vego.'<br />Picknick mit Fisch: '.$fisk.'<br />Picknick mit Aufschnitt: '.$kott.' 
                     </p>
                     <p>Bitte geben Sie Ihre Buchungsnummer ('.$Bokningsnummer.') an, wenn Sie bezüglich Ihrer Buchung uns kontaktieren. </p>
...
<div class="pagecontainer">
    ...
    <div class="topicwide" >       
    	...
    	<h2>Es tut uns sehr leid!</h2>
    	<p>Leider haben wir nur '.$bike_check.' freie Fahrräder an dem von Ihnen gewählten Tag! <br /> Bitte ändern Sie Ihre Buchung oder rufen Sie uns unter +46 (0)506 - 77 75 50 an, so können wir Ihnen vielleicht weiterhelfen!</p>
...
?>
    ...
    $(function() {
        $( "#from" ).datepicker({
            ...
            onSelect: function(a, b) {
                ...
                $('#pris').val(total); 
                $('#pris_1').val("Summe: " +total+" kr");
                $('#pris_2').val("Summe: " +total+" kr"); 
    ...
    function cykelAntal(sel){
        ...
        $('#pris_1').val("Summe: " +total+" kr");
        $('#pris_2').val("Summe: " +total+" kr"); 
        $('#lunch').val("Anzahl Picknick: "+lunch); 
        $('#cyklar').val("Anzahl Fahrräder: "+antal); 
...
echo '<div class="field" style="visibility: visible;">
		...
		<h2 class="page_one">Fahrrad buchen</h2>
        <div class="page_one">
        
        <label for="datepicker">Anmietedatum *</label><br />
        <input type="text" name="cykelfom" id="from" readonly="true" value=""><br />
        <label for="datepicker">Rückgabedatum *</label><br />
        <input type="text" name="cykeltom" id="to" readonly="true" value=""><br />
        <br />
        <label>Anzahl 28" Fahrräder</label><br />
        ...
        <label>(Möchten Sie Kinderräder, -sitze oder Anhänger mieten, so geben Sie dies bitte auf der nächsten Seite an)</label><br /><br />
        <br />
        
        
        <label>Zuwahl Picknickkörbe</label><br />
        <label>Vegetarisch</label><br />
        ...
        <select name="kott" id="kott" onchange="lunchAntal(this)"><option value="0"></option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option></select><br />
            ...
            <input type="button" name="next" onclick="nextPage()" value="Weiter"> 
            </div>
        
        <div class="page_two">
        <h2 style="top:-35px;">Komplette Buchung</h2><input type="button" name="next" onclick="prevPage()" style="position:absolute; width:30px; height:20px; right:0%; top:-30px; padding:0px;" value="<<"> 
        ...
        <label for="comments">Weitere Informationen (Allergien, Aktions-codes, etc.)</label><br />
            <textarea  name="comments" maxlength="1000" cols="27" rows="6"></textarea><br /><br />
        <input type="submit" name="submitbike" onclick="return checkOut()" value="Buchung bestätigen"> 
        </div></form>';
        ?>
